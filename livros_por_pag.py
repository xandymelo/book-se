...
def livros_por_quantidade_de_pag():
    ...
    dataframe = DfsUsados.dataframe[['title', 'categories', 'num_pages', 'average_rating']]
    ...
    st.subheader(''' Em relação aos livros bem avaliados, a média de quantidade de páginas é de {:.0f}, e o desvio padrão é {:.1f} '''.format(dataframe_wihout_0['num_pages'].mean(),dataframe_wihout_0['num_pages'].std()))
